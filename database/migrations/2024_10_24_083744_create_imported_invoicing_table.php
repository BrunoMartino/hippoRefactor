...
return new class extends Migration
{
    ...
    {
        Schema::create('imported_invoicing', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('link_nf')->nullable();
            $table->string('link_xml')->nullable();
            $table->date('birth_date')->nullable();
            $table->string('gender')->nullable();
            $table->string('uf')->nullable();
            $table->enum('situacao', ['Em aberto', 'Em andamento', 'Atendido', 'Em separação', 'Verificado']);
    ...
    {
        Schema::dropIfExists('imported_invoicing');
    }
};
