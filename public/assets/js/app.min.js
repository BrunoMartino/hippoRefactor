      ...
      switch (settings.SidebarType) {
        ...
        case "full":
          ...
          var setsidebartype = function () {
            ...
            if (width < 1300 || localStorage.getItem('sidebar') == 'mini') {
...
$(function () {
  ...
  function criarCookieTema(valor) {
    var dataExpiracao = new Date();
    dataExpiracao.setFullYear(dataExpiracao.getFullYear() + 1); // Adiciona 1 ano à data atual

    var cookieString = `${encodeURIComponent('tema')}=${encodeURIComponent(valor)};`;
  ...
  function handlesidebar() {
    $(".sidebartoggler").on("click", function () {
      ...
      $('.collapse.first-level.in').removeClass('in')
      $('.sidebar-link.has-arrow.active').removeClass('active')
