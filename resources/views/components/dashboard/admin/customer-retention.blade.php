        ...
        <div class="card-body">
            <div class="d-flex flex-row">
                ...
                <div class="ms-3 align-self-center">
                    <h4 class="mb-0 fs-5">Taxa Retenção Clientes</h4>
                    <span class="text-muted"></span>
                </div>
                <div class="ms-auto align-self-center">
                    <h2 class="fs-7 mb-0">{{ $percent }}%</h2>
                </div>
            </div>
            <div class="progress text-bg-light mt-3">
                <div class="progress-bar text-bg-info" role="progressbar"
                    style="width: {{ $percent }}%; height: 6px;" aria-valuenow="25" aria-valuemin="0"
