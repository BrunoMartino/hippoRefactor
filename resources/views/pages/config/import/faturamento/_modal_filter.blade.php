    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-lg-4 pt-lg-3">
                <!-- Filtros -->
                <form action="{{ route('config.import.ft.imported-data') }}" method="get" id="form-filtro">
                            ...
                            <div class="mt-2 mb-2">
                                <div class="mb-2">
                                    <select id="g" class=" select-nome  form-control custom-select2"
                                        ...
                                        <option value=""></option>
                                        @foreach (\App\Models\ImportedOrderGroup::where('user_id', user_princ()->id)->where('module_id', 2)->get(['id','name']) as $item)
