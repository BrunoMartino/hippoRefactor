    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Importar Dados - Faturamento</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Importar Dados - Faturamento</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="content-01">
                    ...
                    <div class="alert alert-light text-dark mb-3 " role="alert">
                        <div class="fs-4 mb-3 fw-ssemibold text-uppercase">Tipos de situação dos pedidos:</div>
                        <div class="mb-1">
                            <span class="fw-semibold">Em aberto</span> <span class="d-inline-block mx-1">→</span> Pedido recebido, aguardando pagamento
                        </div>
                        <div class="mb-1">
                            <span class="fw-semibold">Em andamento</span> <span class="d-inline-block mx-1">→</span> Pedido pago, aguardando emissão da NF
                        </div>
                        <div class="mb-1">
                            <span class="fw-semibold">Atendido</span> <span class="d-inline-block mx-1">→</span> Pedido com NF gerada, aguardando separação
                        </div>
                        <div class="mb-1">
                            <span class="fw-semibold">Em separação</span> <span class="d-inline-block mx-1">→</span> Pedido com NF gerada, autorizada e sincronizado, aguardando ser
                            embalado
                        </div>
                        <div class="mb-1">
                            <span class="fw-semibold">Verificado</span> <span class="d-inline-block mx-1">→</span> Pedido embalado e etiquetado, pronto para ser enviado/coletado
                        </div>
                    ...
                    <div class="mb-1">
                        Modelos de arquivos:
                        <a href="{{ asset('assets/files/modelo-faturamento-xlsx.xlsx') }}" class="btn btn-sm btn-light py-0"
                            download>
                            <i class="ti ti-download"></i>
                            MODELO-FATURAMENTO-XLSX
                        </a> e
                        <a href="{{ asset('assets/files/modelo-faturamento-csv.csv') }}" class="btn btn-sm btn-light py-0"
                            download>
                            <i class="ti ti-download"></i>
                            MODELO-FATURAMENTO-CSV
                        </a>.
                    </div>

                    <form action="{{ route('config.import.ft.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
...
@endsection
@section('scripts')
@if (auth()->user()->hasPermissionTo('criar-import-faturamento') == false)
<script>
