...
@section('content')
                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Dados Importados - Faturamento</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <tbody class="">
                                    @foreach ($data as $item)
                                        <tr class="">
                                            ...
                                            <td class="border-0 py-2 ">
                                                <div class=" fw-semibold px-1 pt-2 pe-3 text-center ">
                                                    <div class="text-truncate" style="padding-right: 3px">
                                                        {{ $item->situacao }}
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <td class="border-0 py-2 px-3 pt-2 ">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button type="button" data-bs-toggle="tooltip"
                                                            ...
                                                            onclick="serUrlDelete2('{{ route('config.import.ft.destroy-item') }}?id={{ $item->id }}')">
                    ...
                    <div class="d-flex flex-column justify-content-start mb-4 flex-sm-row gap-3 gap-sm-4 pt-5 mt-3">
                        <a href="{{ route('config.import.ft.imported-data') }}" class="btn btn-primary  px-5 fs-5">
    ...
    {{-- Modal filtro --}}
    @include('pages.config.import.faturamento.imported_data._modal_filter')
