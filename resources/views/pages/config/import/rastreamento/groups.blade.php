...
@section('content')
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between mb-4">
                        ...
                        <div class="">
                            @if (session('edit_sending_message_id'))
                                <a href="{{ route('config.import.rt.imported-data.back-edit-config-msg') }}"
                                        ...
                                        <tr class="align-items-center ">
                                            ...
                                            <td class="border-0 py-2 px-3 pt-2 ">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('config.import.rt.imported-data.show', $item->id) }}"
                                                    ...
                                                    @can('deletar-import-rastreamento')
                                                        <button type="button" data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            onclick="serUrlDelete(`{{ route('config.import.rt.destroy', $item->id) }}`)">
    ...
    @include('pages.config.import.rastreamento._modal_filter')
