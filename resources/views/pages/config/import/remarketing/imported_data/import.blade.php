    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Importar Dados - Remarketing</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Importar Dados - Remarketing</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="content-01">
                    ...
                    <div class="mb-1">
                        Modelos de arquivos:
                        <a href="{{ asset('assets/files/modelo-remarketing-xlsx.xlsx') }}" class="btn btn-sm btn-light py-0"
                            download>
                            <i class="ti ti-download"></i>
                            MODELO-REMARKETING.XLSX
                        </a> e
                        <a href="{{ asset('assets/files/modelo-remarketing-csv.csv') }}" class="btn btn-sm btn-light py-0"
                            download>
                            <i class="ti ti-download"></i>
                            MODELO-REMARKETING.CSV
                        </a>.
                    </div>
                    <form action="{{ route('config.import.rm.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
...
@section('scripts')
    @if (auth()->user()->hasPermissionTo('criar-import-remarketing') == false)
        <script>
