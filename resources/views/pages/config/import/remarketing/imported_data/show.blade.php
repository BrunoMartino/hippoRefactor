...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Dados Importados - Remarketing</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Dados Importados - Remarketing</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between mb-4">
                        ...
                        @can('criar-import-remarketing')
                            <div class="">
                                <a href="{{ route('config.import.rm.index') }}" class="btn btn-primary  px-4">
                            ...
                            <table class="table table-hover table-striped table-hover  ">
                                <thead>
                                    <tr class="border-0 text-center">
                                        ...
                                        @can('deletar-import-remarketing')
                                            <th scope="" class="py-0 border-0 pb-2 ps-0 text-truncate">
                                                <div class="p-3 border rounded-2 fw-semibold fs-4 text-primary  text-truncate">
                                                    UF
                                                </div>
                                    ...
                                    @foreach ($data as $item)
                                        <tr class="">
                                            ...
                                            <td class="border-0 py-2 ">
                                                <div class=" fw-semibold px-1 pt-2  pe-3 text-center">
                                                    <div class="" style="padding-right: 3px">
                                                        {{ date('d/m/Y', strtotime($item->date_order)) }}
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <td class="border-0 py-2 px-3 pt-2 ">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button type="button" data-bs-toggle="tooltip"
                                                            ...
                                                            onclick="serUrlDelete2('{{ route('config.import.rm.destroy-item') }}?id={{ $item->id }}')">
                    ...
                    <div class="d-flex flex-column justify-content-start mb-4 flex-sm-row gap-3 gap-sm-4 pt-5 mt-3">
                        <a href="{{ route('config.import.rm.imported-data') }}" class="btn btn-primary  px-5 fs-5">
    ...
    {{-- Modal filtro --}}
    @include('pages.config.import.remarketing.imported_data._modal_filter')
