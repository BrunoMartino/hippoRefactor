    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Novo Cupom</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Novo Cupom</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror"
                                    name="code" id="code" placeholder="" value="{{ old('code') }}" required
                                    maxlength="20" />
                                @error('code')
                                    <div class="invalid-feedback fw-semibold"> {{ $message }} </div>
                                @enderror
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <input type="date" class="form-control @error('expiration_date') is-invalid @enderror"
                                    name="expiration_date" id="expiration_date" min="{{ date('Y-m-d') }}" placeholder=""
                            ...
                            <div class="col-12 col-md-6 col-lg-3 mb-4 mb-md-0">
                                ...
                                <input type="text" class="form-control @error('qtd_total') is-invalid @enderror"
                                    name="qtd_total" id="qtd_total" placeholder="0" value="{{ old('qtd_total') }}"
                                    required />
                                @error('qtd_total')
                                    <div class="invalid-feedback fw-semibold"> {{ $message }} </div>
                                @enderror
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <input type="text" class="form-control @error('qtd_uso') is-invalid @enderror"
                                    name="qtd_uso" id="qtd_uso" placeholder="0" value="{{ old('qtd_uso') }}" required />
                                @error('qtd_uso')
                                    <div class="invalid-feedback fw-semibold"> {{ $message }} </div>
                                @enderror
                            </div>
                                ...
                                <div class="d-flex gap-2 justify-content-between align-items-center">
                                    <div class="">
                                        <input type="text" class="form-control @error('value') is-invalid @enderror"
                                            name="value" id="value" placeholder="0,00" value="{{ old('value') }}"
                                            required />
                                        @error('value')
                                            <div class="invalid-feedback fw-semibold"> {{ $message }} </div>
                                        @enderror
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control @error('percent') is-invalid @enderror"
                                            name="percent" id="percent" placeholder="%" value="{{ old('percent') }}"
                                            required />
                                        @error('percent')
                                            <div class="invalid-feedback fw-semibold"> {{ $message }} </div>
                                        @enderror
                                ...
                                <div class="btns-check-custom">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="radio" class="btn-check" name="occurrence" value="sim"
                                            ...
                                            @if (old('occurrence') == 'sim') checked @endif>
                                        ...
                                        <input type="radio" class="btn-check" name="occurrence" value="nao"
                                            ...
                                            @if (old('occurrence', 'nao') == 'nao') checked @endif>
                                ...
                                <div class="btns-check-custom">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="radio" class="btn-check" name="situation" value="ativo"
                                            ...
                                            @if (old('situation', 'ativo') == 'ativo') checked @endif>
                                        ...
                                        <input type="radio" class="btn-check" name="situation" value="desativado"
                                            ...
                                            @if (old('situation') == 'desativado') checked @endif>
...
@section('scripts')
    ...
    <script>
        ...
        IMask(
            document.getElementById('rec_duration'), {
                mask: '000000000'
            }
        );
