        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-3 mb-sm-0">
                                <h5 class="card-title fw-semibold">Mensagens Enviadas</h5>
                                {{-- <p class="card-subtitle mb-0">Lorem ipsum</p> --}}
                            </div>
                            <!-- Filtro -->
                            <div class="">
                                <div class="">
                                    <div class="dropdown">
                                        <button class="btn btn-none px-2 py-1 bg-light " type="button"
                                            onclick="document.getElementById('modal-filtro-grafico-clientes').style.display='flex';"
                                            title="Filtrar">
                                            <i class="ti ti-adjustments fs-6"></i>
                                        </button>
                                    </div>
                                    <!-- Modal filtro -->
                                    <div id="modal-filtro-grafico-clientes" class="modal-filtro-grafico p-3"
                                        style="display: none">
                                        <div class="modal-filtro-grafico-body shadow-lg rounded-3 p-3"
                                            style="width: 300px;">

                                            <button type="button" class="btn btn-fechar-modal-filtro"
                                                onclick="document.getElementById('modal-filtro-grafico-clientes').style.display='none';">
                                                <i class="ti ti-x"></i>
                                            </button>
                                            ...
                                            <div class="">
                                                <!-- ini -->
                                                <div class="mb-3">
                                                    <label for="input-msg-enviada-periodo-ini" class=" mb-1">
                                                        Data Inicial:
                                                    </label>
                                                    <input id="input-msg-enviada-periodo-ini"
                                                        class="form-control   w-100" type="date">
                                                </div>

                                                <div class="">
                                                    <label for="input-msg-enviada-periodo-fin" class=" mb-1">
                                                        Data Final:
                                                    </label>
                                                    <input id="input-msg-enviada-periodo-fin"
                                                        class="form-control  w-100" type="date">
                                                </div>

                                                <div class="text-center mt-3">
                                                    <button id="btn-aplicar-filtro-msg-enviada" type="button"
                        ...
                        <div class="row align-items-center">
                            <div id="chart-adm-msg-enviadas"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class=" col-lg-4">
                <x-dashboard.admin.customer-retention />
                <x-dashboard.admin.canceled />
                <x-dashboard.admin.inadimplencia />
            </div>
        ...
        <div class="row">
                            ...
                            <div class="row mt-4 gx-0">
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="text-cesnter">
                                        {{-- <h6 class="fw-semibold">Remarketing</h6> --}}
                                        <h6 class="fs-5 text-center">Remarketing</h6>
                                    </div>
                                    <div id="chart-pie-modulo-remarketing" data-dados=@json($usuariosRemarketing)
                                        class=""></div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="text-cesnter">
                                        <h6 class="fs-5 text-center">Faturamento</h6>
                                    </div>
                                    <div id="chart-pie-modulo-faturamento" data-dados=@json($usuariosFaturamento) class=""></div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="text-cesnter">
                                        <h6 class="fs-5 text-center">Cobranças</h6>
                                    </div>
                                    <div id="chart-pie-modulo-cobrancas" data-dados=@json($usuariosCobrancas) class=""></div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="text-cesnter">
                                        <h6 class="fs-5 text-center">Rastreamento</h6>
                                    </div>
                                    <div id="chart-pie-modulo-rastreamento" data-dados=@json($usuariosRastreamento) class=""></div>
                                </div>
                            </div>
            ...
            <div class="col-lg-12 d-flex align-items-strech">
                <div class="card w-100 position-relative">
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-3 mb-sm-0">
                                <h5 class="card-title fw-semibold">Upgrade e Downgrade de Planos</h5>
                                {{-- <p class="card-subtitle mb-0">Lorem ipsom</p> --}}
                            </div>
                            ...
                            <div class="">
                                <div class="">
                                    <div class="dropdown">
                                        <button class="btn btn-none px-2 py-1 bg-light " type="button"
                                            onclick="document.getElementById('modal-filtro-grafico-up-dow').style.display='flex';"
                                            title="Filtrar">
                                            <i class="ti ti-adjustments fs-6"></i>
                                        </button>
                                    </div>
                                    <!-- Modal filtro -->
                                    <div id="modal-filtro-grafico-up-dow" class="modal-filtro-grafico p-3"
                                        style="display: none">
                                        <div class="modal-filtro-grafico-body shadow-lg rounded-3 p-3"
                                            style="width: 300px;">

                                            <button type="button" class="btn btn-fechar-modal-filtro"
                                                onclick="document.getElementById('modal-filtro-grafico-up-dow').style.display='none';">
                                                <i class="ti ti-x"></i>
                                            </button>
                                            ...
                                            <div class="">
                                                <!-- ini -->
                                                <div class="mb-3">
                                                    <label for="input-up-dow-planos-periodo-ini" class=" mb-1">
                                                        Data Inicial:
                                                    </label>
                                                    <input id="input-up-dow-planos-periodo-ini"
                                                        class="form-control   w-100" type="date">
                                                </div>

                                                <div class="">
                                                    <label for="input-up-dow-planos-periodo-fin" class=" mb-1">
                                                        Data Final:
                                                    </label>
                                                    <input id="input-up-dow-planos-periodo-fin"
                                                        class="form-control  w-100" type="date">
                                                </div>

                                                <div class="text-center mt-3">
                                                    <button id="btn-aplicar-filtro-up-dow" type="button"
                                                        class="btn btn-primary btn-sm px-3">
                                                        Aplicar
                                                    </button>
                                                </div>
                        ...
                        <div id="chart-bar-up-dow-planos"></div>
            ...
            <div class="col-lg-12 d-flex align-items-strech">
                <div class="card w-100 position-relative">
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-3 mb-sm-0">
                                <h5 class="card-title fw-semibold">Novo Clientes</h5>
                                {{-- <p class="card-subtitle mb-0">Lorem ipsom</p> --}}
                            </div>
                            ...
                            <div class="">
                                <div class="">
                                    <div class="dropdown">
                                        <button class="btn btn-none px-2 py-1 bg-light " type="button"
                                            onclick="document.getElementById('modal-filtro-grafico-novos-clientes').style.display='flex';"
                                            title="Filtrar">
                                            <i class="ti ti-adjustments fs-6"></i>
                                        </button>
                                    </div>
                                    <!-- Modal filtro -->
                                    <div id="modal-filtro-grafico-novos-clientes" class="modal-filtro-grafico p-3"
                                        style="display: none">
                                        <div class="modal-filtro-grafico-body shadow-lg rounded-3 p-3"
                                            style="width: 300px;">
                                            <button type="button" class="btn btn-fechar-modal-filtro"
                                                onclick="document.getElementById('modal-filtro-grafico-novos-clientes').style.display='none';">
                                                <i class="ti ti-x"></i>
                                            </button>
                                            <div class="">
                                                <!-- ini -->
                                                <div class="mb-3">
                                                    <label for="input-novos-clientes-periodo-ini" class=" mb-1">
                                                        Data Inicial:
                                                    </label>
                                                    <input id="input-novos-clientes-periodo-ini"
                                                        class="form-control   w-100" type="date">
                                                </div>

                                                <div class="">
                                                    <label for="input-novos-clientes-periodo-fin" class=" mb-1">
                                                        Data Final:
                                                    </label>
                                                    <input id="input-novos-clientes-periodo-fin"
                                                        class="form-control  w-100" type="date">
                                                </div>

                                                <div class="text-center mt-3">
                                                    <button id="btn-aplicar-filtro-novos-clientes" type="button"
                                                        class="btn btn-primary btn-sm px-3">
                                                        Aplicar
                                                    </button>
                                                </div>
                        ...
                        <div id="chart-line-novo-clientes"></div>
            ...
            <div class="col-lg-6 d-flex align-items-strech">
                <div class="card w-100 position-relative">
                    <div class="card-body dados-receitar-gerada">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-1 mb-sm-0">
                                <h5 class="card-title fw-semibold">Receita Gerada por Cliente</h5>
                                {{-- <p class="card-subtitle mb-0">Lorem ipsom</p> --}}
                            </div>
                            ...
                            <div class="">
                                ...
                                <div id="modal-filtro-grafico-novos-clientes" class="modal-filtro-grafico p-3"
                                    style="display: none">
                                    <div class="modal-filtro-grafico-body shadow-lg rounded-3 p-3" style="width: 300px;">
                                        <div class="">
                                            <!-- ini -->
                                            <div class="mb-3">
                                                <label for="input-novos-clientes-periodo-ini" class=" mb-1">
                                                ...
                                                <input id="input-novos-clientes-periodo-ini" class="form-control   w-100"
                                                    type="date">
                                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <input id="input-novos-clientes-periodo-fin" class="form-control  w-100"
                                                    type="date">
                                            </div>
                        ...
                        <!-- datatable -->
                        <x-dashboard.admin.revenue-generated />
            ...
            <div class="col-lg-6 d-flex align-items-strech">
                <div class="card w-100 position-relative">
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-1 mb-sm-0">
                                <h5 class="card-title fw-semibold">Mensagens Excedentes</h5>
                                {{-- <p class="card-subtitle mb-0">Lorem ipsom</p> --}}
                            </div>
                        </div>
                        <!-- table -->
                        <x-dashboard.admin.excess-messages />
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-7 pb-2">
                        <div class="me-3 pe-1">
                            <img src="../assets/images/profile/user-1.jpg" class="shadow-warning rounded-2"
