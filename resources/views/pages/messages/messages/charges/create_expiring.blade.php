                ...
                <div class="card-body">
                    ...
                    @if ($msgExist)
                        <div class="alert alert-light text-dark fs-4 mb-4" role="alert"
                            ...
                            Já existe uma mensagem do tipo <i class="">COBRANÇA VENCENDO</i>, e você só pode ter
                    ...
                    <form action="{{ route('messages.crud.charges.store') }}" method="post">
                                        ...
                                        <select id="type"
                                            ...
                                            @if (userHasModule(1))
                                                ...
                                                @if (existOpcaoConfigEnvioCobranca('enviar_notificacao_de_fatura_vencendo'))
                                                    <option value="COBRANÇA VENCENDO" selected>
                                                        COBRANÇA VENCENDO
                                                    </option>
                                                @endif
                        ...
                        <div class="mb-3">
                            ...
                            @php
                                $qtdDias = 'qtd-dias';
                                $desc = "Olá, tudo bem?
O Boleto referente ao serviço XXXXXXXX vence em {{ $qtdDias }} dias.
Nome: {{ nome }}
Contrato: {{ contrato }}
