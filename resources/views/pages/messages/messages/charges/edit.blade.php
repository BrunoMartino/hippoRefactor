        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('messages.charges.update', $message->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            @switch($message->type)
                                ...
                                @case('COBRANÇA VENCIMENTO')
                                    <div class="d-flex flex-wrap gap-1">
                                        ...
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ link }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ saudacao }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ qtd-"."dias }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ valor }" @endphp}</button>
                                    </div>
                                @break
                                ...
                                @case('COBRANÇA VENCIDA')
                                    <div class="d-flex flex-wrap gap-1">
                                        ...
                                        <button type="button" id="move-nf" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ nota-" . "fiscal }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ contrato }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ vencimento }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
                                            ondragstart="dragStart(event)"
                                            ondragend="dragEnd(event)">{@php echo "{ link }" @endphp}</button>
                                        <button type="button" class="drag-btn rounded-2" draggable="true"
