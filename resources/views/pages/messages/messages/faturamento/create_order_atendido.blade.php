                ...
                <div class="card-body">
                    ...
                    @if ($msgExist)
                        <div class="alert alert-light text-dark fs-4 mb-4" role="alert"
                            ...
                            Já existe uma mensagem do tipo <i class="">FATURAMENTO - PEDIDO ATENDIDO</i>, e você
                            só
                            pode ter
                                    ...
                                    <div class="mb-2">
                                        <select id="type"
                                            ...
                                            @if (userHasModule(2))
                                                ...
                                                <option value="FATURAMENTO - PEDIDO ATENDIDO" selected>
...
Seu pedido {{ pedido }} está em processo de atendimento, nota fiscal {{ $nF }} gerada. 📦✨
