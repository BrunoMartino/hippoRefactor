                ...
                <div class="card-body">
                    ...
                    @if ($msgExist)
                        <div class="alert alert-light text-dark fs-4 mb-4" role="alert"
                            ...
                            Já existe uma mensagem do tipo <i class="">FATURAMENTO - PEDIDO EM SEPARAÇÃO</i>, e você
                            só
                            pode ter
                                    ...
                                    <div class="mb-2">
                                        <select id="type"
                                            ...
                                            @if (userHasModule(2))
                                                ...
                                                <option value="FATURAMENTO - PEDIDO EM SEPARAÇÃO" selected>
...
Seu pedido {{ pedido }} está em processo de separação, nota fiscal {{ $nF }} gerada e autorizada. Aguardando ser embalado. 📦✨
