                ...
                <div class="card-body">
                    ...
                    @if (session('whatsapp_nao_configurado'))
                        <div class="alert alert-danger text-centers" role="alert">
                            ...
                            <a href="{{ route('messages.faturamento.redi-config-whatsapp') }}" class="btn btn-primary mt-2 fs-4">
                                Configurar Whatsapp
                            </a>
                        </div>
                    @endif
                    
                    <form action="{{ route('messages.faturamento.update', $message->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="alert mt-2 alert-warning d-inline-block p-2 py-1" role="alert">
                            <div class="small">
                                Clique em algum dos itens acima e mova para o campo de descrição (Esses nomes virão da integração ou dos dados importados).
                            </div>
                        </div>
                        <div class="alert alert-light text-dark mb-4" role="alert"
                            style="">
