    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Nova Mensagem</h4>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12 col-lg-5 col-xxl-4">
                                ...
                                <div class="select2-tipo-mensagem">
                                    <div class="mb-2">
                                        <select id="type" class=" select-tipo  form-control custom-select2"
                                            ...
                                            @if (userHasModule(3))
                                                ...
                                                <option value="PESQUISA SATISFAÇÃO"
                                                    @if (old('type') == 'PESQUISA SATISFAÇÃO')  @endif>
                            ...
                            <div class="mb-3 col-12 col-lg-7 col-xxl-8">
                                ...
                                <input type="text" class="form-control fs-5 @error('name') is-invalid @enderror"
                                    name="name" id="name" placeholder="" value="{{ old('name') }}" disabled
                                    required />
                                @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control fs-5 @error('description') is-invalid @enderror" name="description" id="description"
                                rows="10" disabled required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback fw-semibold">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-3 gap-sm-4 pt-2 mt-4">
                            <button type="submit" class="btn btn-primary  px-5 fs-5" disabled>
