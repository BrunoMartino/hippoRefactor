                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Agradecimento</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('messages.crud.store') }}" method="post">
                        @csrf
                        <div class="row">
                                ...
                                <div class="select2-tipo-mensagem">
                                    <div class="mb-2">
                                        <select id="type"
                                            ...
                                            @if (userHasModule(3))
                                                <option value="AGRADECIMENTO" selected>
                                                    AGRADECIMENTO</option>
                                                <option value="ANIVERSÁRIO">
                                                    ANIVERSÁRIO</option>
                                                <option value="PESQUISA SATISFAÇÃO"
                                                    @if (old('type') == 'PESQUISA SATISFAÇÃO') selected @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control fs-5 @error('description') is-invalid @enderror" name="description" id="description"
                                rows="10" @if ($whatsappConfig == false) disabled @endif required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback fw-semibold">{{ $message }}</div>
                            @enderror
                        </div>
