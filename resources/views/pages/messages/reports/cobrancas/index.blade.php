...
@section('title', 'Relatório Cobranças Enviadas')
@section('style')
    <style>
...
@section('content')
    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="d-flex flex-column  flex-lg-row gap-2 align-items-lg-center">
                <div class="col-lg-4">
                    <h4 class="fw-semibold mb-8">Relatório Cobranças Enviadas</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb flex-nowrap text-truncate">
                            ...
                            <li class="breadcrumb-item pe-3" aria-current="page">Relatório Cobranças Enviadas</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between mb-4">
                        ...
                        <div class="">
                            <div class="dropdown">
                                <a href="{{ route('messages.charge-report.export-excel') }}?{{ request()->getQueryString() }}"
                                ...
                                <table class="table table-hover table-striped table-hover  ">
                                    <thead>
                                        <tr class="border-0 text-center">
                                            ...
                                            <th scope="" class="py-0 border-0 pb-2 ps-0">
                                                <div
                                                    class="p-3 border rounded-2 fw-semibold fs-4 text-primary text-center  text-truncate">
                                                    Envio
                                                </div>
                                            </th>
                                            <th scope="" class="py-0 border-0 pb-2 ps-0">
                                        ...
                                        @foreach ($reports as $report)
                                            <tr class="align-items-center ">
                                                ...
                                                <td class=" border-0 py-2 ">
                                                    <div class=" fw-semibold px-1 pt-2 pe-3 text-uppercase text-center">
                                                        @switch($report->message->type)
                                                ...
                                                <td class=" border-0 py-2">
                                                    <div class=" fw-semibold px-1 pt-2 text-center pe-3 ">
                                                        {{ date('d/m/Y', strtotime($report->vencimento)) }}
                                                    </div>
                                                </td>
                                                <td class=" border-0 py-2">
                                                    <div class=" fw-semibold px-1 pt-2 text-center pe-3 ">
                                                ...
                                                <td class=" border-0 py-2">
                                                    <div class=" fw-semibold px-1 pt-1 pb-1  ">
                                                        <div class="d-flex justify-content-center gap-2">
                                                            <a href="{{ route('messages.charge-report.show', $report->id) }}"
    ...
    {{-- Modal filtro --}}
    @include('pages.messages.reports.cobrancas._modal_filter')
@endsection
