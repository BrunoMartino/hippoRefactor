    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-lg-4 pt-lg-3">
                <!-- Filtros -->
                <form action="{{ route('messages.ft-report.index') }}" method="get" id="form-filtro">
                    <ul class="mx-3" style="list-style:circle ">
                        ...
                        <li class="d-none" style="max-width: 500px">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="form-check form-switch col-12  mb-1">
                                            <input class="form-check-input " name="t1" type="checkbox"
                                                value="nf" id="tipo-nf" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t1') == 'nf') checked @endif />
                                        ...
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t2" type="checkbox"
                                                value="pe" id="tipo-pe" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t2') == 'pe') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-pe">
                                                Faturamento Pedido
                                            </label>
                                        </div>
...
<script>
    ...
    function changeTypeCheckbox(target) {
        ...
        setTimeout(() => {
            ...
            let pe = document.getElementById('tipo-pe');
            let nf = document.getElementById('tipo-nf');


            if (pe.checked || nf.checked) {
                todos.checked = false
