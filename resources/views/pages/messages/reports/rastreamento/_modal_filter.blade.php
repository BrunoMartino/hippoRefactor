    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-lg-4 pt-lg-3">
                <!-- Filtros -->
                <form action="{{ route('messages.rt-report.index') }}" method="get" id="form-filtro">
                    <ul class="mx-3" style="list-style:circle ">
                                            ...
                                            <select id="pedido" class=" select-pedido  form-control custom-select2"
                                                ...
                                                @foreach ($allReport as $item)
                                                    <option value="{{ $item->idPedido }}"
                                                        @if (request()->get('pedido') == $item->idPedido) selected @endif>
                                                        {{ $item->idPedido }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="mt-2 mb-2">
                                        <div class="mb-2">
                                            <select id="nf" class=" select-nf  form-control custom-select2"
                                                ...
                                                <option value=""></option>
                                                @foreach ($allReport as $item)
                                                    <option value="{{ $item->idNotaFiscal }}"
                                                        @if (request()->get('nf') == $item->idNotaFiscal) selected @endif>
                                                        {{ $item->idNotaFiscal }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select id="contrato" class=" select-contrato  form-control custom-select2"
                                                ...
                                                @foreach ($allReport as $item)
                                                    <option value="{{ $item->idContrato }}"
                                                        @if (request()->get('contrato') == $item->idContrato) selected @endif>
                                                        {{ $item->idContrato }}
                                                    </option>
                                                @endforeach
                                            </select>
                        ...
                        <li class="" style="max-width: 500px">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t1" type="checkbox"
                                                value="pos" id="tipo-t1" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t1') == 'pos') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-t1">
                                                POSTADO
                                            </label>
                                        </div>
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t2" type="checkbox"
                                                value="en" id="tipo-t2" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t2') == 'en') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-t2">
                                                ENTREGUE
                                            </label>
                                        </div>
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t3" type="checkbox"
                                                value="la" id="tipo-t3" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t3') == 'la') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-t3">
                                                LOCALIZAÇÃO ATUAL
                                            </label>
                                        </div>
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t4" type="checkbox"
                                                value="se" id="tipo-t4" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t4') == 'se') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-t4">
                                                SAIU ENTREGAR
                                            </label>
                                        </div>
                                        <div class="form-check form-switch col-12 col-sm-6 col-md-6  mb-1">
                                            <input class="form-check-input " name="t5" type="checkbox"
                                                value="au" id="tipo-t5" style="width: 30px; height: 16px;"
                                                onchange="changeTypeCheckbox(this)"
                                                @if (request()->get('t5') == 'au') checked @endif />
                                            <label class="form-check-label ms-1" for="tipo-t5">
                                                AUSENTE
                                            </label>
                                        </div>
...
<script>
    ...
    function changeTypeCheckbox(target) {
        ...
        setTimeout(() => {
            ...
            let t1 = document.getElementById('tipo-t1');
            let t2 = document.getElementById('tipo-t2');
            let t3 = document.getElementById('tipo-t3');
            let t4 = document.getElementById('tipo-t4');
            let t5 = document.getElementById('tipo-t5');
