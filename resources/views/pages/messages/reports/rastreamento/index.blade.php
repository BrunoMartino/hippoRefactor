...
@section('content')
    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="d-flex flex-column  flex-lg-row gap-2 align-items-lg-center">
                <div class="col-lg-4">
                    <h4 class="fw-semibold mb-8">Relatório Rastreamento</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb flex-nowrap text-truncate">
                            ...
                            <li class="breadcrumb-item pe-3" aria-current="page">Relatório Rastreamento</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between mb-4">
                        ...
                        <div class="">
                            <div class="dropdown">
                                <a href="{{ route('messages.rt-report.export-excel') }}?{{ request()->getQueryString() }}"
                                                ...
                                                <td class=" border-0 py-2">
                                                    <div class=" fw-semibold px-1 pt-1 pb-1  ">
                                                        <div class="d-flex justify-content-center gap-2">
                                                            <a href="{{ route('messages.rt-report.show', $report->id) }}"
    ...
    {{-- Modal filtro --}}
    @include('pages.messages.reports.rastreamento._modal_filter')
@endsection
