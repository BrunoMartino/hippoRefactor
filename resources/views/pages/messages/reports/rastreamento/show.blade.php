...
@section('title', 'Visualizar Rastreamento')
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Visualizar Rastreamento</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none"
                                    href="{{ route('messages.charge-report.index') }}">Relatório Rastreamento</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Visualizar Rastreamento</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="mb-3 col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="border-bottom pb-1">
                                <div class="fs-6"><strong>Status Entrega:</strong></div>
                                <div class="fs-5">
                                    @if (is_null($report->situacao_entrega))
                                        -
                                    @else
                                        @switch($report->situacao_entrega)
                                            @case('postado')
                                                POSTADO
                                            @break
                        ...
                        <!-- Data Visualização -->
                        <div class="mb-3 col-12 col-sm-6 col-md-4 col-lg-6">
                            <div class="border-bottom pb-1">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 gap-sm-4 pt-5 mt-3">
                        ...
                        @else
                            <a href="{{ route('messages.rt-report.index') }}" class="btn btn-primary  px-5 fs-5">
                                <div class="px-lg-5">Voltar</div>
                            </a>
                        @endif
                    </div>
