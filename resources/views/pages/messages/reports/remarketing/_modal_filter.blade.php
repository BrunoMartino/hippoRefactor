    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-lg-4 pt-lg-3">
                <!-- Filtros -->
                <form action="{{ route('messages.rm-report.index') }}" method="get" id="form-filtro">
                    <ul class="mx-3" style="list-style:circle ">
                                    ...
                                    <div class="mt-2 mb-2">
                                        <div class="mb-2">
                                            <select id="nome" class=" select-nome  form-control custom-select2"
                                                ...
                                                <option value=""></option>
                                                @php
                                                    $reportNameCustomers = \App\Models\MessageReport::where(
                                                        'user_id',
                                                        user_princ()->id,
                                                ...
                                                @endphp
                                                @foreach ($reportNameCustomers->get() as $item)
                        ...
                        <!-- Data envio -->
                        <li class="">
                            <label class="fs-5 fw-semibold">Data envio:</label>
                            <div class="mt-2 mb-2">
                                <div class="mb-2 row g-2 g-lg-4">
                                    <div class="col-lg-6">
                                        <label for="">Mín</label>
                                        <input type="date" class="form-control" name="dt_envio_min" id=""
                                            value="{{ request()->get('dt_envio_min') }}" placeholder="" />
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="">Máx</label>
                                        <input type="date" class="form-control" name="dt_envio_max" id=""
                                            value="{{ request()->get('dt_envio_max') }}" placeholder="" />
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="text-center d-flex mt-4 pt-2 flex-column flex-md-row gap-2 justify-content-center">
                        ...
                        <button type="button" class="btn btn-light text-primary px-5 "
                            onclick="resetarFiltro('form-filtro');document.getElementById('t-todos').checked=false;document.getElementById('t-todos').click()">
...
<script>
    ...
    function changeTypeCheckbox(target) {
        ...
        setTimeout(() => {
            ...
            if (ag.checked || an.checked || pes.checked) {
                todos.checked = false
