        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-lg-4 pt-lg-3">
                <div class="">
                    ...
                    <textarea class="form-control visually-hidden" name="message_no_receiving_notifications_text" id="msg-not" rows="3">{{ old('message_no_receiving_notifications_text', str_replace("\r\n\r\nPara se retirar da lista de notificações envie SAIR.", '', $dataSettings->message_no_receiving_notifications_text)) }}</textarea>
                    <textarea class="form-control" id="msg-not-insert" rows="3">{{ old('message_no_receiving_notifications_text', str_replace("\r\n\r\nPara se retirar da lista de notificações envie SAIR.", '', $dataSettings->message_no_receiving_notifications_text)) }}</textarea>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-3 gap-sm-4 pt-2 ">
                            ...
                            <button type="button" class="btn btn-primary  px-2 fs-3"
                                ...
                                @if ($dataSettings->message_no_receiving_notifications_text != '')
