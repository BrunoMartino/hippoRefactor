        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <x-alerts.error />
                    <x-alerts.warning />
                    <form action="{{ route('payment.change-plan.confirm-payment-plan') }}" method="post"
                                                ...
                                                <div class="pt-4">
                                                    ...
                                                    <div class="text-center mt-3 mb-5 pt-5">
                                                        <div
                                                            ...
                                                            <a href="{{ route('payment.change-plan.pix') }}"
                                                                class="btn btn-light text-orange  px-5 fs-4" id="btn-voltar">
                                                                <div class="px-lg-4">
                                                                    Pagar com Pix
                                                                </div>
                                                            </a>
