            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form action="{{ route('payment.change-plan.confirm-payment-plan', $plan->id) }}" method="post"
                        id="form" onsubmit="verificarFormCartao(event)">
                        @csrf
                        <div class="pagamento">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 px-0">
                                        ...
                                        <div>
                                            ...
                                            <ul id="tabs-metodo-pg"
                                                ...
                                                role="tablist">
                                                <li class="nav-item  w-100 p-lg-5 @if ($tipoPagamento == 'pix') d-none @endif"
                                                    id='nav-tab-cartao'>
                                                ...
                                                <li class="nav-item w-100 p-lg-5" id="nav-tab-pix">
                                                    {{-- <a class=" " --}}
                                                    <a class=" nav-link py-3 px-5 mx-auto text-center @if ($tipoPagamento == 'pix') active @else  ms-md-0 me-md-auto @endif"
                                            ...
                                            <div class="row">
                                                <div class="col-12 px-0 px-md-3">
                                                    <hr id="divisor" class="mt-5 mt-lg-0 ">
                                                </div>
                                            </div>
                                            <!-- Tab panes -->
                                            <div class="tab-content">
                                                ...
                                                <!-- Cartão -->
                                                <div class="tab-pane @if ($tipoPagamento != 'pix') active @endif"
                                                    id="cartao" role="tabpanel">
                                                    <div class="pt-4">
                                                        ...
                                                        <div class="text-center mt-5 mb-5 pt-5">
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    <div class="px-lg-4">Pagar com PIX</div>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <button type="button" class="btn btn-primary  px-5 fs-4" id="btn-confirmar-pix" onclick="confirmarPix()">
                                    <div class="px-lg-4">Confirmar Pagamento</div>
                                </button>
                                @if (!session('tipoPagamento'))
                                    <button type="button" class="btn btn-light  px-5 fs-4 text-primary" id="btn-voltar" onclick="pixVoltar()">
                                        <div class="px-lg-4">Pagar com cartão</div>
                                    </button>
                                @endif
