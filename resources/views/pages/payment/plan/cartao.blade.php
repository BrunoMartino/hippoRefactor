                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Pagamento - Cartão</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('payment.confirm-payment-plan') }}" method="post" onsubmit="verificarFormCartao(event)">
                        @csrf
                        <div class="pagamento">
                            <div class="container">
                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-lg-10  mx-auto">
                                                            <div class="text-center mt-4 lh-sm fs-2 ">
                                                                <h5>Pagamento Seguro SSL - Seu pagamento é protegido por criptografia
                                                                SSL de alta qualidade.</h5> <h6>Os dados do seu cartão são
                                                                    criptografados e é gerado um token para processar o pagamento.</h6> <h6>Não
                                                                        armazenamos nenhum dado direto do seu cartão em nosso banco de
                                                                        dados.</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="text-center mt-3 mb-5 pt-5">
                                                        <div
                                                            ...
                                                            <a href="{{ route('payment.pix') }}"
                                                                class="btn btn-orange  px-5 fs-4" id="btn-voltar">
                                                                <div class="px-lg-4">
                                                                    Pagar com Pix
                                                                </div>
                                                            </a>
