        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form action="{{ route('usuarios.comprar.pagar.finalizar') }}" method="post" id="form"
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 px-0">
                                        ...
                                        <div>
                                            <!-- Nav tabs -->
                                            <ul class="nav tabs-modulos nav-tabs  gap-4 flex-column flex-md-row flex-nowrap "
                                                role="tablist">
                                                <li class="nav-item  w-100 p-lg-5" id='nav-tab-cartao'>
                                                    <a class="nav-link py-3 px-5 mx-auto me-md-0 ms-md-auto text-center active"
                                                        ...
                                                        <div class="py-4">
                                                            <div class="mb-2">
                                                                {{-- <i class="ti ti-credit-card fs-13"></i> --}}
                                                ...
                                                <div class="tab-pane" id="pix" role="tabpanel">
                                                    <div class="pt-4">
                                                        ...
                                                        <div class="text-center fw-semibold fs-4 my-4 py-3">
                                                            Abra o aplicativo do seu banco, escolha pagar com PIX e aponte a
                                                            câmera para
                                                            o
                                                            QR Code.
                                                        </div>
