    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-body">
                ...
                <x-alerts.error />
                <x-alerts.warning />
                <form action="{{ route('usuarios.comprar.confirm-payment-card') }}" method="post" id="form">
                    @csrf
                    <div class="row">
                    ...
                    <div class="px-1">
                        ...
                        <div class="d-flex flex-column flex-lg-row bg-light px-3 py-3 pt-2 align-items-center rounded mt-2">
                            {{-- <div class="fs-5">
                                    Cartão:
                    ...
                    <div class="">
                        <div class=" ">
                            ...
                            <div class="input-group" style="max-width: 330px; ">
                                <div type="text" class="form-control fs-6 py-1 px-4 " style="border-color: rgb(189, 189, 189) !important">
                                    {{ $card->card_number }}
                                </div>
                                <span class="input-group-text bg-transparent border px-2 py-1" style="border-color: rgb(189, 189, 189) !important" id="basic-addon2">
                                    <img src="{{ $card->url_brand }}" class="" height="14" alt="{{ $card->brand }}" />
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="ms-auto">
                        <div class="d-flex gap-2 pt-2">
                            <a href="{{ route('usuarios.comprar.change-card') }}" class="btn btn-primary">
                                TROCAR
                            </a>
                        </div>
                    </div>
